        ...
        <React.Fragment>
            ...
            <Container className="section-margin">
                ...
                <FadeUpTrigger stagger={0.5}>
                    <p className="mt-20">
                        A next-generation platform for creating verifiable digital commitments, legally binding 
                        agreements, and transparent social obligations, ensuring accountability and trust.
                    </p>
